...
def ks(histpair, ks_cut=0.35, min_entries=10000, **kwargs):
    ...
    is_good = (
        data_hist_Entries >= min_entries
    )  # data_hist_Entries != 0 and data_hist_Entries >= min_entries
    ...
    return PluginResults(c, show=is_outlier, info=info, artifacts=artifacts)
